class RecevedOrder {
  ...
  bool status;
  String message;
  List<RecevedOrderData> data;

  RecevedOrder({this.code, this.status, this.message, this.data});

  RecevedOrder.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = <RecevedOrderData>[];
      json['data'].forEach((v) {
        data.add(new RecevedOrderData.fromJson(v));
      });
    }
  }
...
class RecevedOrderData {
  ...
  RecevedOrderData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
