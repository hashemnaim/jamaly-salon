class VendorsService {
  ...
  bool status;
  String message;
  List<VendorsServiceData> data;

  VendorsService({this.code, this.status, this.message, this.data});

  VendorsService.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = <VendorsServiceData>[];
      json['data'].forEach((v) {
        data.add(new VendorsServiceData.fromJson(v));
      });
    }
  }
...
class VendorsServiceData {
 ...
 var name;
  ...
  VendorsServiceData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    email = json['email'];
    mobile = json['mobile'];
