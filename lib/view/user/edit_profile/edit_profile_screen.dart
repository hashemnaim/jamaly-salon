                      ...
                      children: [
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                      color: Color(0xffFFE451), width: 2)),
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              CustomTextFormField(
                                textInitialValue: homeUserController
                                        .getProfileUserData.value.data.name ??
                                    '',
                              ...
                              CustomTextFormField(
                                textInitialValue: homeUserController
                                        .getProfileUserData.value.data.email ??
                                    '',
                                prefixIcon:
                                    Icon(Icons.email_outlined, size: 22.r),
                                isBoxShadow: false,
                                onSaved: setEmail,
                              ),
                              SizedBox(height: 10.h),
                              CustomTextFormField(
                                textInitialValue: homeUserController
                                        .getProfileUserData.value.data.mobile ??
                                    '',
                                prefixIcon:
                                    Icon(Icons.call_outlined, size: 22.r),
                                isBoxShadow: false,
                                onSaved: setMobile,
                              ),
                              SizedBox(height: 10.h),
                        ...
                        CustomButton(
                            ...
                            onTap: () {
                              ...
                              AuthApis.authApis
                                  .setProfileUser(name, email, mobile);
                            }),
                      ],
                    ),
                  ),
