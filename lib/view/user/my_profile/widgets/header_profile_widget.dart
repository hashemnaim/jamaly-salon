...
import 'package:yacht_booking/view/user/edit_profile/edit_profile_screen.dart';
...
class HeaderProfileWidget extends StatefulWidget {
  ...
  @override
  _HeaderProfileWidgetState createState() => _HeaderProfileWidgetState();
}
                  ...
                  Column(
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          CustomText(
                            'التوقيت في بلدك : ${DateFormat.jm().format(DateTime.now())}',
                            fontWeight: FontWeight.bold,
                            fontSize: 9,
                          ),
                          SizedBox(width: 5.w),
