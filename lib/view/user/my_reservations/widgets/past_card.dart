...
class PastCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx((){
      ...
      ListView.separated(
        itemCount: homeUserController.getBookingsData.value.oldOrders.length,
        ...
        itemBuilder: (context, index) {
          OldOrders oldOrders = homeUserController.getBookingsData.value.oldOrders[index];
          return InkWell(
          onTap: (){
            HomeUserApis.homeUserApis.getOwnerDetails(
                                    oldOrders.owner.id.toString());
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          IconRow(Icons.location_on, '${oldOrders.owner.location??""}',),
                        ],
                      ),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
