...
import 'package:yacht_booking/view/user/reservation_confirmation/date_wid.dart';
...
class DatePicker2 extends StatefulWidget {
  ...
  DatePicker2(
    ...
    this.selectionColor = AppColors.borderColor,
    this.deactivatedColor = AppColors.borderColor,
...
class _DatePickerState extends State<DatePicker2> {
