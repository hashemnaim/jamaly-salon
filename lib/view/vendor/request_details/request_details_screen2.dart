...
class RequestDetailsScreen2 extends StatelessWidget {
  RequestDetailsScreen2();
  HomeVendorController homeVendorController = Get.find();
  GlobalKey<FormState> addOffers = GlobalKey<FormState>();
  String price, note;
  HomeUserController homeUserController = Get.find();

  setPeice(String value) {
    this.price = value;
  }
    ...
    return Obx(() {
      return Scaffold(
        ...
        body: SizedBox(
          ...
          child: homeVendorController.getRequestDetailsData.value.data == null
              ? Center(
                          ...
                          children: [
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      CustomText(
                                        '${homeVendorController.getRequestDetailsData.value.data.user.name ?? ''}',
                                        alignment:
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          SvgRow(
                                            'call',
                                            '${homeVendorController.getRequestDetailsData.value.data.user.mobile ?? ''}',
                                            svgColor:
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                CustomText(
                                  ' ${homeVendorController.getRequestDetailsData.value.data.date} ',
                                  alignment: AlignmentDirectional.centerStart,
                                  fontWeight: FontWeight.bold,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: CustomText(
                                      '${homeVendorController.getRequestDetailsData.value.data.duration}',
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: CustomText(
                                      '${homeVendorController.getRequestDetailsData.value.data.from}-${homeVendorController.getRequestDetailsData.value.data.to}',
                                      fontColor: AppColors.fontSecondaryColor,
                                      fontSize: 12,
                                    ),
                                  ),
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: CustomText(
                                      '${homeVendorController.getRequestDetailsData.value.data.numberOfPersones}',
                                      fontColor: AppColors.fontSecondaryColor,
                                      fontSize: 12,
                                    ),
                                  ),
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    CustomText(
                                      '${homeVendorController.getRequestDetailsData.value.data.price}',
                                      fontSize: 10,
                                      fontWeight: FontWeight.bold,
                                      fontColor: AppColors.fontSecondaryColor,
                                    )
                            ...
                            CustomTextFormField(
                              hintText:
                                  '${homeVendorController.getRequestDetailsData.value.data.notes}',
                              maxLines: 3,
                              isBoxShadow: false,
                              // isBorderSide: false,
                            ...
                            //                 homeVendorController.getRequestDetailsData.value.data.id.toString()
                            //               );
                            //     // showDialog(
                            //     //   context: context,
                        ...
                        child: Column(
                          children: [
                            ...
                            CustomButton(
                              text: 'ارسال عرض',
                              onTap: () {
                                if (addOffers.currentState.validate()) {
                                  addOffers.currentState.save();
                                  Get.back();
