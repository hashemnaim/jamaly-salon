...
class CustomDropDownServiceVendor extends StatelessWidget {
  final value;
  final List<SubServiceVendorModelData> itemsList;
  ...
  const CustomDropDownServiceVendor({
    @required this.value,
        ...
        child: DropdownButtonHideUnderline(
          child: Padding(
            ...
            child: DropdownButton<dynamic>(
              ...
              items: itemsList
                  .map(
                    (SubServiceVendorModelData item) =>
                        DropdownMenuItem<SubServiceVendorModelData>(
                      value: item,
                      child: CustomText(
                        item.title,
                        fontColor: fontColor,
